...
from SMPyBandits.Policies.Exp3R import Exp3R
...
"""
def exp3r_bs_sac(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0, 
    ...
    policy = Exp3R(ac_kwargs['num_heads'], horizon = 4000, lower = -50, amplitude= 4450)
    policy.startGame()
    head = policy.choice()
